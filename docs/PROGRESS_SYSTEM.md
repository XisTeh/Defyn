...
O Progresso reúne fatos registrados por período:

- peso e tendência por janelas de sete dias;
- medidas parciais, check-ins, fotos e comparação;
- sessões, duração, séries, volume e evolução por exercício;
- água nos dias com entrada;
