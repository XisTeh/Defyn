...
Excluir foto exige confirmação e remove metadata e blob numa transação. Excluir perfil também inclui mídias de progresso no cascade. O backup v7 serializa a mídia necessária como data URL JPEG/PNG/WebP e valida formato e referência antes de restaurar.
