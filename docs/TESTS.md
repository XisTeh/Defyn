...
Estado atual após o hardening 06.5: **199 testes em 38 arquivos**, todos aprovados. A etapa adiciona seis regressões para tokenização contextual, golden fixtures limpa/câmera, estados de traço/quantidade não significativa, scaling 100→70/80, cards mobile sem coluna escondida e correção de perspectiva com quatro cantos.
...
- OCR nutricional 06.5: passe numérico separado, associação por bounding boxes/linha/coluna, regressões 409/359/49/189/89/29, traço sem zero, declaração de quantidade não significativa e fixtures golden textuais;
...
O QA 06.5 isolou a revisão golden em Chrome com emulação móvel real. Em 320×800, 360×800, 390×844 e 430×932, `documentElement.scrollWidth` foi exatamente igual ao viewport (320, 360, 390 e 430). As três células mediram respectivamente cerca de 81, 95, 105 e 118 px e permaneceram visíveis no mesmo card, com o status abaixo.

O ensaio OCR real sintético reproduziu inclusive `g` reconhecido como `9`: a fixture limpa retornou inicialmente `359`, `49`, `189`, `89` e `29` no texto bruto, mas a matriz final coincidiu integralmente com 100 g/60 g/%VD. A fixture inclinada retornou `199`, `239`, `549`, `9,79`, `159`, `7,89` e `19` no bruto e terminou com 19/3, 23/3, 54/8, 9,7/1,5 e 7,8/1 nas colunas corretas, preservando a declaração de quantidade não significativa.
