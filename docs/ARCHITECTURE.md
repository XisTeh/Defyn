...
Vite carrega Diário, Treinos, Progresso, Rotina e Backup por chunks. Workbox precacheia shell, chunks, CSS, fontes, ícones e 241 miniaturas de exercícios; nunca mídia pessoal. `autoUpdate` adia reload durante sessão de academia, bootstrap, sync crítico, conflito ou fluxos críticos já existentes.
