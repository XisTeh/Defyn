export const OFFLINE_GLOB_PATTERNS = ['**/*.{js,css,html,woff2,png}'] as const;

export type OfflineAssetKind = 'shell' | 'module' | 'exercise-thumbnail' | 'pwa-icon' | 'personal-media' | 'unsupported';
